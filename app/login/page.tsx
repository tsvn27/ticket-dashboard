...
const errorMessages: Record<string, string> = {
  ...
  unauthorized: "Você não tem permissão para acessar o painel.",
    ...
    <div className="min-h-screen bg-background flex items-center justify-center">
      <div className="w-full max-w-sm p-8">
        <div className="text-center mb-8">
          <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-foreground text-background font-bold text-xl mx-auto mb-4">
            TB
          </div>
          <h1 className="text-2xl font-semibold text-foreground">Ticket Bot</h1>
